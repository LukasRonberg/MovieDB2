...
public class HibernateConfig {
    ...
    private static Properties setDeployedProperties(Properties props, String db){
        props.setProperty("hibernate.connection.url", System.getenv("CONNECTION_STR") + db);
        props.setProperty("hibernate.connection.username", System.getenv("DB_USERNAME"));
        props.setProperty("hibernate.connection.password", System.getenv("DB_PASSWORD"));
        return props;
    }

    private static Properties setDevProperties(Properties props, String db){
        props.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/"+ db);
